...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "Website"),
        ("About", "Sobre"),
        ("Slogan_tip", "IPMon - \"O Poder do Controle em Suas Mãos\""),
        ...
        ("Request access to your device", "Solicita acesso ao seu dispositivo"),
        ...
        ("view_camera_unsupported_tip", "O dispositivo remoto não suporta a visualização da câmera."),
        ("Enable camera", "Ativar câmera"),
        ("No cameras", "Nenhuma câmera detectada"),
        ("d3d_render_tip", "Quando a renderização D3D está ativada, a tela remota pode ficar preta em algumas máquinas."),
        ("Use D3D rendering", "Usar renderização D3D"),
        ("Printer", "Impressora"),
        ("printer-os-requirement-tip", "A função de saída da impressora requer o Windows 10 ou superior."),
        ("printer-requires-installed-{}-client-tip", "Para usar a impressão remota, {} precisa estar instalado neste dispositivo."),
        ("printer-{}-not-installed-tip", "A impressora {} não está instalada."),
        ("printer-{}-ready-tip", "A impressora {} está instalada e pronta para uso."),
        ("Install {} Printer", "Instalar impressora {}"),
        ("Outgoing Print Jobs", "Trabalhos de impressão de saída"),
        ("Incomming Print Jobs", "Trabalhos de impressão recebidos"),
        ("Incoming Print Job", "Trabalho de impressão recebidos"),
        ("use-the-default-printer-tip", "Use a impressora padrão"),
        ("use-the-selected-printer-tip", "Use a impressora selecionada"),
        ("auto-print-tip", "Imprima automaticamente usando a impressora selecionada."),
        ("print-incoming-job-confirm-tip", "Você recebeu um trabalho de impressão remoto. Quer executá-lo do seu lado?"),
        ("remote-printing-disallowed-tile-tip", "Impressão Remota não permitida"),
        ("remote-printing-disallowed-text-tip", "As configurações de permissão do lado controlado negam a Impressão Remota."),
        ("save-settings-tip", "Salvar configurações"),
        ("dont-show-again-tip", "Não mostrar isso novamente"),
    ].iter().cloned().collect();
}
