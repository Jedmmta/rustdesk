...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("screenshot-merged-screen-not-supported-tip", "Não é possível mesclar capturas de tela de vários monitores. Alterne para um único monitor e tente novamente."),
        ("screenshot-action-tip", "Selecione como continuar com a captura de tela."),
        ("Save as", "Salvar como"),
